                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>Tiền cần thanh toán <a href="?_sort=true&column=payment_amount&type={{ $type }}"><i
                                        class="fa fa-sort ml-2" aria-hidden="true"></a></th>
                            <th>Thanh toán</th>
                            <th>Điện thoại</th>
                            <th>Đặt hàng <a href="?_sort=true&column=created_at&type={{ $type }}"><i
                                        class="fa fa-sort ml-2" aria-hidden="true"></a></th>
                            <th>Cập nhật <a href="?_sort=true&column=updated_at&type={{ $type }}"><i
                                        class="fa fa-sort ml-2" aria-hidden="true"></a></th>
                            <th>Tình trạng <a href="?_sort=true&column=status&type={{ $type }}"><i
                                        class="fa fa-sort ml-2" aria-hidden="true"></a></th>
                            <th>#</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($orders as $key => $o)
                            <tr>
                                ...
                                <td class="font-weight-bold">{{ number_format($o->payment_amount, 0, ',') }}đ</td>
                                <td>{{ $o->payment }}</td>
                                <td>{{ $o->phone }}</td>
                                <td>{{ $o->created_at }}</td>
                                <td>{{ $o->updated_at }}</td>
                                ...
                                <td>
                                    <a href="{{ route('admin.order.detail', $o['id']) }}" class="btn btn-primary btn-sm"><i
