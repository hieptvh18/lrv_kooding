        ...
        <div class="col-lg-8 col-xlg-9 col-md-7">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.profile.store')}}" class="form-horizontal form-material mx-2" method="POST" id="profile_admin">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input disabled type="email" value="{{Auth::user()->email}}" class="form-control form-control-line" name="email" id="example-email">
                            </div>
                        </div>
                        {{-- <div class="form-group">
                        ...
                        <div class="gender col-md-12 mb-4 mt-4">
                            ...
                            <div class="form-check-inline">
                                <input class="form-check-input" {{Auth::user()->gender == 1 ? 'checked' :''}} value="1" id="gender" type="radio" name="gender">
                                <label for="gender" class="form-check-label mr-4">
                                    Nam
                                </label>
                                <input class="form-check-input" {{Auth::user()->gender == 2 ? 'checked':''}} id="gender2" value="1" type="radio" name="gender">
                    ...
                    <form action="" class="form-horizontal form-material mx-2 mt-5" id="admin_pass">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="password"  name="password" value="{{old('password')}}" class="form-control form-control-line" placeholder="Mật khẩu cũ">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="password" name="new_password" value="" placeholder="Nhập mật khẩu mới" class="form-control form-control-line">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12">Xác nhận mật khẩu mới</label>
                            <div class="col-md-12">
                                <input type="password" placeholder="Xác nhận mật khẩu mới" name="confirm_password" value="" class="form-control form-control-line">
