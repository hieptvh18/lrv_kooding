...
<body>
          ...
          <div class="col-lg-7 mx-auto text-white">
            <div class="row align-items-center d-flex flex-row">
              ...
              <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                <h2>SORRY!</h2>
                <h3 class="font-weight-light">Oops! Authorization.</h3>
              </div>
            </div>
            <div class="row mt-5">
  ...
  <!-- inject:js -->
  <script src="./public/jsadmin/js/off-canvas.js"></script>
  <script src="./public/jsadmin/js/hoverable-collapse.js"></script>
  <script src="./public/jsadmin/js/template.js"></script>
  <script src="./public/jsadmin/js/settings.js"></script>
  <script src="./public/jsadmin/js/todolist.js"></script>
  <!-- endinject -->
</body>
